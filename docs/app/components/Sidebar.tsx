...
const navigation: NavItem[] = [
  {
    ...
    children: [
      ...
      { title: 'First Agent Session', href: '/docs/getting-started/first-agent' },
    ],
  },
  {
    title: 'Modules',
    ...
    children: [
      { title: 'Agents Monitor', href: '/docs/modules/agents' },
      { title: 'Commanders', href: '/docs/modules/commanders' },
      { title: 'Command Room', href: '/docs/modules/command-room' },
      { title: 'Telemetry Hub', href: '/docs/modules/telemetry' },
      { title: 'Factory', href: '/docs/modules/factory' },
      { title: 'Services', href: '/docs/modules/services' },
    ],
  },
  {
    title: 'API Reference',
    ...
    children: [
      ...
      { title: 'Commanders API', href: '/docs/api/commanders' },
      { title: 'Command Room API', href: '/docs/api/command-room' },
      { title: 'Telemetry API', href: '/docs/api/telemetry' },
  ...
  },
  {
    ...
    children: [
      { title: 'iOS / Capacitor', href: '/docs/deployment/ios' },
    ],
  },
]
