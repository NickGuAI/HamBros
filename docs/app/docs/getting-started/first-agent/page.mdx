...
- Learn about [Commanders](/docs/docs/modules/commanders) to set up persistent agent personas
- Explore the [Telemetry Hub](/docs/docs/modules/telemetry) to track costs across sessions
- Set up recurring tasks in the [Command Room](/docs/docs/modules/command-room)
