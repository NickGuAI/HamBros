...
Use the `hammurabi onboard` CLI command to automatically configure agents to send telemetry to your HamBros instance. See the [CLI Reference](/docs/docs/cli) for details.
